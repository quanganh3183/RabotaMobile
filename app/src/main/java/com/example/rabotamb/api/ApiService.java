...
public interface ApiService {
    ...
    Call<ResumeResponse> getResumesByCompany(
            @Path("companyId") String companyId,
            @Query("current") int current,
            @Query("pageSize") int pageSize
    );
    ...
    Call<ResponseBody> updateResumeStatus(
    ...
    Call<ApplicationHistoryResponse> getApplicationHistory(
            @Header("Authorization") String token,
            @Body Map<String, Object> body
    );

    @POST("api/v1/resumes")
    Call<ResponseBody> createResume(@Header("Authorization") String token,
                                    @Body Map<String, Object> body);

    @Multipart
    @POST("api/v1/files/upload")
    Call<ResponseBody> uploadFile(@Header("Authorization") String token,
                                  @Header("folder-type") String folderType,
