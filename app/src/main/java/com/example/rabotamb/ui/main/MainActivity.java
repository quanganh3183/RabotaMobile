...
import com.example.rabotamb.ui.profile.ApplicationHistoryActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupBottomNavigation() {
        navView.setOnItemSelectedListener(item -> {
            ...
            else if (itemId == R.id.navigation_history && isLoggedIn) {
                // Thêm code chuyển đến màn hình lịch sử ứng tuyển
                Intent intent = new Intent(this, ApplicationHistoryActivity.class);
                startActivity(intent);
                return true;
            }
